...
class Shop(models.Model):
    ...
    seller = models.ForeignKey(MarketplaceUser, on_delete=models.CASCADE, blank=True, null=True)
...
class Cart(models.Model):
    buyer = models.ForeignKey(MarketplaceUser, on_delete=models.CASCADE)
    shop = models.ForeignKey(Shop, on_delete=models.CASCADE)
